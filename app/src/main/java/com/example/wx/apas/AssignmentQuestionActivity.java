...
public class AssignmentQuestionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        assignment_id = bundle.getInt("assignment_id");
        ...
        bcompilation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog = ProgressDialog.show(AssignmentQuestionActivity.this,"COMPILING","",true);
        ...
        bruninput.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                code = inputcode.getText().toString();
                userinput = inputip.getText().toString();
                progressDialog = ProgressDialog.show(AssignmentQuestionActivity.this,"RUNNING THE INPUT","",true);
                new JSONTaskPOST().execute(url);
            }
        });
        ...
        bpretest.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                code = inputcode.getText().toString();
                userinput = inputip.getText().toString();
                progressDialog = ProgressDialog.show(AssignmentQuestionActivity.this,"CHECKING WITH PRETEST","",true);
                new JSONTaskPOST().execute(url);
            }
        });
        ...
        bsubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url=Constants.ROOT_URL + "/mobile/assignment-submit/";
                type = "submit";
                code = inputcode.getText().toString();
                userinput = inputip.getText().toString();
                progressDialog = ProgressDialog.show(AssignmentQuestionActivity.this,"Submitting the code","",true);
                new JSONTaskPOST().execute(url);
            }
        });
...
/*
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(AssignmentQuestionActivity.this);
